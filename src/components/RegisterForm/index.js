...
import { REGISTER, Signup } from "../../gql/mutations/auth";
...
export const RegisterForm = ({ activateAuth }) => {
  ...
  const handleSubmit = (event) => {
    ...
    authSignup({
      ...
      .catch((e) => {
        console.log("yjgjycgcjycdwgyjdcg", e);
        setError(e.message);
        setIsDisabled(false);
        setIsLoading(false);
      });
        ...
        >
          ...
          <div className="form-group">
            ...
            <small id="passwordHelp" className="form-text text-muted">
              At least 8 characters. It must contain numbers, lowercase letters
              and uppercase letters. The spaces are not allowed
            </small>
          </div>
          <div className="form-group">
            <label
